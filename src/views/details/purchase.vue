    ...
    <ul class="details-a">
      ...
      <li>
        ...
        <span class="browse" style="position: relative; margin-left: 20px">
          <img src="../../assets/examine.png" alt="" id="examine" />2212
          <!-- <div class="clear"></div> -->
        </span>
        <span class="browse" style="position: relative; margin-left: 20px">
          <img src="../../assets/ax1.png" alt="" id="ax1" />
          2122</span
        >
      </li>
      <!-- <li class="price">
      ...
      <li>
        <el-button class="details-button" type="primary">Off shelf</el-button>
      </li> -->
      <li>
        <el-button class="details-button_a" type="primary">Edit</el-button>
      </li>
